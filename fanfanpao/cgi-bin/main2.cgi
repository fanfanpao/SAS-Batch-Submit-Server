...
#		$curdirl = "/$basedir/html/departments/cdm/casper2/home";
		$curdirl = "home";

	 	print "       <tr bgColor=#99bcd8><td colspan=3 width=100%><font color=\"white\">/home</font></td></tr>\n";
	}
	else {

#		$curdirl = "/$basedir/html/departments/cdm/casper2/home$FORM{\"curdir\"}";
		$curdirl = "home$FORM{\"curdir\"}";

		$_ = $FORM{"curdir"};
		s/\//\/<wbr>/g;
	 	print "       <tr bgColor=#99bcd8><td colspan=3 width=100%><font color=\"white\">/home$_</font></td></tr>\n";
...
#	 	print "<INPUT TYPE=\"image\" src=\"../image/feet.png\" ALT=\"submit\" name=\"action\" value=\"Take a Tour\"> Take a Tour!\n";
		...
		print "<tr><td colspan=3 width=100% align=center><iframe width=\"100%\" height=\"600\" scrolling=\"auto\" frameborder=\"0\" src=\"../portal.html\"></iframe></td></tr>\n";
