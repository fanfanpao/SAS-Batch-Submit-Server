...
#		$usrpwdf{$usrnamef} = $usrpwdf;
   ...
   if ($usrid eq "" or $usrpwdf{$usrid} ne $usrkey) 
   {
	...
	print "<a href=\"main2.cgi\">You must logon from ScriptsMax(Beta) main page</a>\n";
   } 
   else
   {
